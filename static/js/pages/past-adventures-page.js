...
import {
  buildHTMLListFromData,
  setPageTitle,
} from "../helpers/html-builders.js";
...
function getWorkExperience(adventurer) {
  let adventurerData =
    adventurer === STEPHANIE
      ? stephanieData.experience.jobs
      : louiseData.experience.jobs;
...
function pageFlip(direction) {
  ...
  let lastPage =
    adventurer === STEPHANIE
      ? stephanieData.experience.jobs.length - 1
      : louiseData.experience.jobs.length - 1;
